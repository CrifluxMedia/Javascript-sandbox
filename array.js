...
//Array.isArray checks if a variable is an array or not-checks true if its an array and false if its not an array
console.log(Array.isArray(45));
//changes a data type to an array-to make an array from whatever value i am providing
